...
Which of the outcomes is more likely for a person with ability $\theta_p = 2$?
...
## What might a third item parameter do?
...
- [Exercise](https://github.com/stenhaug/irt-basics/blob/master/exercise.Rmd) associate with this presentation
